...
function MyGenericFormComponent() {
    const { formData, handleChange, handleSubmit, isValid } = useForm<User>({ username: { type: 'text', value: '' }, age: { type: 'number', value: 0 } }, userSchema)
...
export default MyGenericFormComponent
